...
Original file is located at
    https://colab.research.google.com/drive/1Ke6Fx5MYUvGCq0caxLbGDY8FLenyhe_H
"""
...
shutil.copy('/content/drive/MyDrive/EEG2/10_N400.set', 'eeg.set')
shutil.copy('/content/drive/MyDrive/EEG2/10_N400.fdt', 'eeg.fdt')
shutil.copy('/content/drive/MyDrive/EEG2/sub-010_task-N400_events.tsv', 'events.tsv')
...
raw_ica = ica.apply(raw_filtered.copy(), exclude=[0,2,4,7,15,16,18,19])
...
tmax = .8
baseline = (-.1,0)
# get sample indices of response events
...
#201 = correct
#202 = incorrect
mne.viz.plot_compare_evokeds([ERPs['201'],ERPs['202']],picks=['FCz'])
...
epochs_212_crop = epochs['212'].copy().crop(tmin=0.32, tmax=0.33)
epochs_222_crop = epochs['222'].copy().crop(tmin=0.32, tmax=0.33)
...
# Crop til N400-vindue
epochs_212_crop = epochs['212'].copy().crop(tmin=0.33, tmax=0.33)
epochs_222_crop = epochs['222'].copy().crop(tmin=0.33, tmax=0.33)
...
# Crop til N400-vindue
epochs_212_crop = epochs['212'].copy().crop(tmin=0.3, tmax=0.34)
epochs_222_crop = epochs['222'].copy().crop(tmin=0.3, tmax=0.34)
...
# Crop til N400-vindue
epochs_212_crop = epochs['212'].copy().crop(tmin=0.32, tmax=0.32)
epochs_222_crop = epochs['222'].copy().crop(tmin=0.32, tmax=0.32)
