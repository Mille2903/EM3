...
Original file is located at
    https://colab.research.google.com/drive/1BznbtO2V_9cQVBDpoM_XerMj0s8Pt64K
"""
...
shutil.copy('/content/drive/MyDrive/EEG4/13_N400.set', 'eeg.set')
shutil.copy('/content/drive/MyDrive/EEG4/13_N400.fdt', 'eeg.fdt')
shutil.copy('/content/drive/MyDrive/EEG4/sub-013_task-N400_events.tsv', 'events.tsv')
...
raw_ica = ica.apply(raw_filtered.copy(), exclude=[0,4,5,7,8,10,14])
...
epochs_212_crop = epochs['212'].copy().crop(tmin=0.42, tmax=0.46)
epochs_222_crop = epochs['222'].copy().crop(tmin=0.42, tmax=0.46)
...
# Crop til N400-vindue
epochs_212_crop = epochs['212'].copy().crop(tmin=0.45, tmax=0.45)
epochs_222_crop = epochs['222'].copy().crop(tmin=0.45, tmax=0.45)
